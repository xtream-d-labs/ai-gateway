...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Error', 'model/Job', 'model/JobAttrs', 'model/JobAttrs1', 'model/NewJobID'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Error'), require('../model/Job'), require('../model/JobAttrs'), require('../model/JobAttrs1'), require('../model/NewJobID'));
  } else {
    // Browser globals (root is window)
    if (!root.ScaleShift) {
      root.ScaleShift = {};
    }
    root.ScaleShift.JobApi = factory(root.ScaleShift.ApiClient, root.ScaleShift.Error, root.ScaleShift.Job, root.ScaleShift.JobAttrs, root.ScaleShift.JobAttrs1, root.ScaleShift.NewJobID);
  }
}(this, function(ApiClient, Error, Job, JobAttrs, JobAttrs1, NewJobID) {
  'use strict';
