...
func (o *GetApplicationParams) bindCode(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetApplicationParams) validateCode(formats strfmt.Registry) error {
