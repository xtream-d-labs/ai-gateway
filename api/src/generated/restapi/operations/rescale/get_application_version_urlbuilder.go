...
func (o *GetApplicationVersionURL) WithBasePath(bp string) *GetApplicationVersionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetApplicationVersionURL) Build() (*url.URL, error) {
	...
	var _path = "/applications/{code}/{version}/"

	code := o.Code
	if code != "" {
		_path = strings.Replace(_path, "{code}", code, -1)
	} else {
		return nil, errors.New("Code is required on GetApplicationVersionURL")
	}
	...
	if version != "" {
		...
		return nil, errors.New("Version is required on GetApplicationVersionURL")
	}
...
func (o *GetApplicationVersionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetApplicationVersionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetApplicationVersionURL")
	}
