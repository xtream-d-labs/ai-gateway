...
func (o *GetRescaleCoreTypesURL) WithBasePath(bp string) *GetRescaleCoreTypesURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetRescaleCoreTypesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRescaleCoreTypesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRescaleCoreTypesURL")
	}
