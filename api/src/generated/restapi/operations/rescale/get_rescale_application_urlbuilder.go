...
func (o *GetRescaleApplicationURL) WithBasePath(bp string) *GetRescaleApplicationURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetRescaleApplicationURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRescaleApplicationURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRescaleApplicationURL")
	}
