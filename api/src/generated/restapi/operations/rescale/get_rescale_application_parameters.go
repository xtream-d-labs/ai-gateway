...
// NewGetRescaleApplicationParams creates a new GetRescaleApplicationParams object
// no default values defined in spec.
func NewGetRescaleApplicationParams() GetRescaleApplicationParams {

	return GetRescaleApplicationParams{}
}

// GetRescaleApplicationParams contains all the bound params for the get rescale application operation
...
func (o *GetRescaleApplicationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetRescaleApplicationParams) bindCode(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
