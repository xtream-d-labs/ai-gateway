...
// NewGetCoreTypesParams creates a new GetCoreTypesParams object
// no default values defined in spec.
func NewGetCoreTypesParams() GetCoreTypesParams {

	return GetCoreTypesParams{}
}

// GetCoreTypesParams contains all the bound params for the get core types operation
...
func (o *GetCoreTypesParams) bindAppVer(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetCoreTypesParams) bindMinGpus(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
