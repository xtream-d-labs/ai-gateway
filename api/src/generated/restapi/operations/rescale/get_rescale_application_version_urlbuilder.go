...
func (o *GetRescaleApplicationVersionURL) WithBasePath(bp string) *GetRescaleApplicationVersionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetRescaleApplicationVersionURL) String() string {
...
func (o *GetRescaleApplicationVersionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRescaleApplicationVersionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRescaleApplicationVersionURL")
	}
