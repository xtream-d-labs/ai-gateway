...
// NewPostNewImageParams creates a new PostNewImageParams object
// no default values defined in spec.
func NewPostNewImageParams() PostNewImageParams {

	return PostNewImageParams{}
}

// PostNewImageParams contains all the bound params for the post new image operation
...
type PostNewImageParams struct {
	...
	/*
	  ...
	  In: body
	*/
	Body *models.PostNewImageParamsBody
}
...
func (o *PostNewImageParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.PostNewImageParamsBody
