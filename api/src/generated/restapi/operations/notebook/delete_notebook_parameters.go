...
// DeleteNotebookParams contains all the bound params for the delete notebook operation
...
func (o *DeleteNotebookParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
