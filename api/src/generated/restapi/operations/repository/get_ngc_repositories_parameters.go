...
// NewGetNgcRepositoriesParams creates a new GetNgcRepositoriesParams object
// no default values defined in spec.
func NewGetNgcRepositoriesParams() GetNgcRepositoriesParams {

	return GetNgcRepositoriesParams{}
}

// GetNgcRepositoriesParams contains all the bound params for the get ngc repositories operation
// typically these are obtained from a http.Request
//
// swagger:parameters getNgcRepositories
type GetNgcRepositoriesParams struct {
