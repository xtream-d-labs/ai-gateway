...
// NewGetRemoteImagesParams creates a new GetRemoteImagesParams object
// no default values defined in spec.
func NewGetRemoteImagesParams() GetRemoteImagesParams {

	return GetRemoteImagesParams{}
}

// GetRemoteImagesParams contains all the bound params for the get remote images operation
...
func (o *GetRemoteImagesParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
