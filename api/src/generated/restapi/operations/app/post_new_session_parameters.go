...
func NewPostNewSessionParams() PostNewSessionParams {
	...
	return PostNewSessionParams{}
}

// PostNewSessionParams contains all the bound params for the post new session operation
...
type PostNewSessionParams struct {
	...
	/*
	  ...
	  In: body
	*/
	Body *models.PostNewSessionParamsBody
}
...
func (o *PostNewSessionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.PostNewSessionParamsBody
