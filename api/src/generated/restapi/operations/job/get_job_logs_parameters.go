...
// GetJobLogsParams contains all the bound params for the get job logs operation
...
func (o *GetJobLogsParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
