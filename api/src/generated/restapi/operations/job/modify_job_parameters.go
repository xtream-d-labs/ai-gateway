...
// NewModifyJobParams creates a new ModifyJobParams object
...
// ModifyJobParams contains all the bound params for the modify job operation
...
type ModifyJobParams struct {
	...
	/*
	  ...
	  In: body
	*/
	Body *models.ModifyJobParamsBody
	/*Job ID
	  Required: true
	  In: path
	*/
...
func (o *ModifyJobParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.ModifyJobParamsBody
...
func (o *ModifyJobParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
