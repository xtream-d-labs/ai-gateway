...
func (o *GetJobLogsURL) Build() (*url.URL, error) {
	...
	var _path = "/jobs/{id}/logs"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("ID is required on GetJobLogsURL")
	}
...
func (o *GetJobLogsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetJobLogsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetJobLogsURL")
	}
