...
// DeleteImageParamsBody ImageName
// swagger:model deleteImageParamsBody
...
func (m *DeleteImageParamsBody) validateImage(formats strfmt.Registry) error {
