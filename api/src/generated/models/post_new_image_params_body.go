...
// PostNewImageParamsBody ImageName
// swagger:model postNewImageParamsBody
...
func (m *PostNewImageParamsBody) validateImage(formats strfmt.Registry) error {
...
func (m *PostNewImageParamsBody) UnmarshalBinary(b []byte) error {
	var res PostNewImageParamsBody
